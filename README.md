...
- **핵심 도구(live)**: `studio/`의 `build_graded.py`·`patch_apply.py`·`graft.py`·`card_delta.py`·`driver_autocard.py`·`propose_cards.py`·`gen_tactics_story.py`·`gen_tactics_play.py`.
