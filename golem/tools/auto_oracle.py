...
사용:
  python golem/tools/auto_oracle.py --n 3                 # ★키 (방치형 기본)
  python golem/tools/auto_oracle.py --n 3 --packet planning_packet_eco --specqa specqa_packet_eco
"""
import sys as _sys
...
def main(argv=None):
    ...
    base = BUILD_RUNS / f"autooracle-{stamp}"
