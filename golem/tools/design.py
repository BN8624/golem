...
사용:
  python golem/tools/design.py --replay <fixture.json>          # 키 안 씀(plumbing)
  python golem/tools/design.py [--packet <planning_packet>]     # ★키 (사용자 go 뒤에만)
"""
import sys as _sys
...
def main(argv=None):
    ...
    outdir = Path(args.out) if args.out else (SCRATCH / "design_packet")
