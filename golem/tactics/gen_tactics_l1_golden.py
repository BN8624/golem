...
PACKET = PACKETS / "planning_packet_tactics_l1"
SPECQA = PACKETS / "specqa_packet_tactics_l1"
...
def main():
    ...
    ref = BUILD_RUNS / "_tactics_ref_l1_tmp"
    if ref.exists():
        shutil.rmtree(ref)
    ...
    base_tmp = BUILD_RUNS / "_tactics_base_l1_tmp"
    if base_tmp.exists():
