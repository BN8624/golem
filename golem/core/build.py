...
사용:
  python golem/core/build.py --replay <build_response.txt>   # 키 안 씀(plumbing)
  python golem/core/build.py [--packet <dir>] [--cap 11]      # ★키 (사용자 go 뒤에만)
"""
import sys as _sys
...
def main(argv=None):
    ...
    base = Path(args.out) if args.out else (BUILD_RUNS / run_id)
