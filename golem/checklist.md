...
- [ ] **(다음) patch>B 응력(큰 touched 모듈) + §21.2 누적**: ① touched 모듈 하나가 큰 카드로 patch가 B보다 출력 작음을 응력(여기선 engine 작아 0.5≈0.7). ② 여러 카드 누적해 큰 게임 1편을 patch로 완주(레버3 누적회귀가 N장서 버티나). 곁=XL 1000+ / combat 자율oracle / 외부리뷰 P1(#10)
