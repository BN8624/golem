...
- [ ] **(다음) B를 더 큰 카드로**: 시그니처 다수(100+모듈/입력 60~100k)로 키워 B만 재측정 — *입력 lost-in-the-middle*(묻힌 engine 읽나) 천장 찾기. 출력은 여전히 작음. + llm.py 1800초 타임아웃 안전망. + 패치빌드 §21 정합. 곁=combat 자율oracle / 외부리뷰 P1(#10)
