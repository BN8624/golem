...
- [ ] **(다음, 본선) 통합 게임 1편 / B겹·밸런스 결합**: A겹까지 닫혔으니 남은 = B겹 대사(StoryForge, 출력전용·구조검증)·밸런스 config(측정+사람취향)를 patch 누적라인에 붙여 "보여줄 게임 한 편". 측정으론 거의 다 갚음 — 이건 쇼케이스 성격. 곁=다모듈 동시편집 / XL 1000+ / combat 자율oracle / 외부리뷰 P1(#10)
