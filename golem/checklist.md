...
- [ ] **(다음, ★키) patch를 63.5KB station 카드로**: A가 주석 패러프레이즈/기능 재배치한 큰 카드서 patch 돌려 충실도 우위(드리프트 격차) 실응력. + build_graded에 raw 응답 저장 추가해 출력토큰 A/B/patch 정량 대조. 곁=XL 1000+ / combat 자율oracle / 외부리뷰 P1(#10)
